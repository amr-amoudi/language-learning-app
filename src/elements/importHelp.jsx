    ...
    return(
        <div>
            <details>
                ...
                <p>then paste the words data on the 'Words data input' and click on import</p>
                ...
                <div className="worning">
                    ...
                    <h1>if the app keeps crashing <button onClick={handleClick} className="app--crash--button">Click here</button></h1>
                </div>
            </details>
        </div>
    )
